...
class MessageAttachmentMineController(msg_id: Int, cash_source: ChatSearchCard): HBox() {
    ...
    init {
        val fxmlLoader = FXMLLoader(javaClass.getResource("messageAttachmentMine.fxml"))
